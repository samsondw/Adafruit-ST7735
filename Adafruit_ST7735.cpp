...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7735::Adafruit_ST7735(PinName cs, PinName dc, PinName rst) : Adafruit_ST77xx(cs, dc, rst)
{
}
...
void Adafruit_ST7735::setRotation(uint8_t m)
{
	...
	if ((tabcolor == INITR_144GREENTAB) || (tabcolor == INITR_HALLOWING))
		_rowstart = (rotation < 2) ? 3 : 1; // ..._rowstart is 3 for rotations 0&1, 1 for rotations 2&3
